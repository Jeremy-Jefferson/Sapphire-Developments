...
const Gallery = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start">
      ...
      {/* Hero Section */}
      <section className="self-stretch bg-slate-900 h-[350px] flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-6xl font-semibold text-white leading-[48px]">
            Gallery
          </h1>
