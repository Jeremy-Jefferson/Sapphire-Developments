...
const LPFooter = () => {
  return (
    <footer
      className="bg-slate-900 flex flex-col items-center justify-center py-16 md:py-20 px-6 md:px-8 box-border text-gray-300"
      id="Footer"
      role="contentinfo"
      aria-label="Footer"
    >
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 xl:gap-16 mb-12">
          ...
          <div className="flex flex-col items-start text-left" id="Quick Links">
            ...
            <nav className="flex flex-col items-start gap-3" aria-label="Footer navigation">
              ...
              <Link to="/properties" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Properties</Link>
              <Link to="/about-us" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">About Us</Link>
              <Link to="/contact-us" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Contact</Link>
            </nav>
          </div>
          ...
          <div className="flex flex-col items-start text-left" id="Properties">
            ...
            <nav className="flex flex-col items-start gap-3" aria-label="Property links">
              <Link to="/properties" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">For Sale</Link>
              <Link to="/rent" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">For Rent</Link>
              <Link to="/gallery" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Gallery</Link>
              <Link to="/our-agents" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Our Agents</Link>
            </nav>
          </div>
          ...
          <div className="flex flex-col items-start text-left" id="Legal">
            ...
            <nav className="flex flex-col items-start gap-3" aria-label="Legal links">
              <Link to="/" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Terms of Services</Link>
              ...
              <Link to="/" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Accessibility</Link>
            </nav>
          </div>
        </div>
        
        {/* Visual Divider */}
        <div className="w-full border-t border-white/10 mt-10 pt-6"></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
          ...
          <div className="flex items-center gap-4 order-1 md:order-2" aria-label="Social media links">
            ...
            <a
              ...
              target="_blank"
              className="p-2.5 bg-white/5 hover:bg-blue-600 rounded-full transition-all duration-200 hover:scale-110"
            ...
            <a
              ...
              rel="noopener noreferrer"
              target="_blank"
              className="p-2.5 bg-white/5 hover:bg-gray-700 rounded-full transition-all duration-200 hover:scale-110"
